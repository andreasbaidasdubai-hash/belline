...
| `scripts/site-llms.ts` | `/llms.txt` and the sector pages' JSON-LD, generated from the catalogue, the markets module, the language registry and the flags. `npm run check:llms` fails if either drifts from them. |
