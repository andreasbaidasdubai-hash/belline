...
import { COMMON_TIMEZONES, locationUsage } from "@/lib/locations";
...
export default async function LocationsPage() {
  ...
  return (
    <>
      ...
      <LocationsManager venues={venues} canManage={canManageUsers(user)} timezones={COMMON_TIMEZONES} />
    </>
  );
}
