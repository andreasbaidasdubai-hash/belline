...
const FAQS = [
  ...
  },
  {
    ...
    a: "You're welcome to message me on WhatsApp: that's Belline's own number, and it's me who answers. For your business, WhatsApp is coming soon: we're waiting on Meta's approval.",
  },
  {
