...
const FAQS = [
  ...
  },
  {
    ...
    a: "Yes. Belline answers WhatsApp for your business on a second number you register with it: you get a new number for the business and we set it up with you, and your own WhatsApp stays as it is. It answers in English from your information and passes requests to your team; it can't listen to voice notes yet. And you can message me on WhatsApp: that's Belline's own number, and it's me who answers.",
  },
  {
