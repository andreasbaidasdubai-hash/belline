...
export const HELP_ARTICLES: HelpArticle[] = [
  ...
  },
  {
    ...
    body: "On most mobiles you dial a short code once: one for when nobody answers, one for when the line is busy and one for when the phone is off. The Phone & WhatsApp step shows the codes with your Belline number already in them. Then ring your own number from another phone to test it.",
  },
  {
  ...
  },
  {
    ...
    body: "Calls are forwarded to your Belline number. If it is not on the Phone & WhatsApp step yet, it is being prepared and appears there as soon as it is ready.",
  },
  {
    id: "website-snippet",
    ...
    body: "Copy the one line from the Website chat step and paste it just before the closing body tag, usually once in the shared footer. Website builders have their own place for it; the page shows the steps for yours. Publish, then open your site to check the chat button appears.",
  },
  {
    id: "test",
