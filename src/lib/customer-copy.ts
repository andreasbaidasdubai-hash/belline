...
export const CUSTOMER_COPY = {
  ...
  "call.mic_blocked": { en: "Microphone blocked", de: "Mikrofon blockiert" },
  "call.mic_blocked_help": {
    en: "To talk, allow the microphone for this site: open the site settings next to the address bar (the lock or settings icon), set Microphone to Allow, then press Retry.",
    de: "Um zu sprechen, erlauben Sie das Mikrofon für diese Website: Öffnen Sie die Website-Einstellungen neben der Adressleiste (das Schloss- oder Einstellungssymbol), stellen Sie Mikrofon auf Zulassen und tippen Sie dann auf Erneut versuchen.",
  },
  "call.mic_missing": { en: "No microphone available", de: "Kein Mikrofon verfügbar" },
  "call.mic_missing_help": {
    en: "Connect a microphone, or close any other app that is using it, then press Retry.",
    de: "Schließen Sie ein Mikrofon an oder beenden Sie eine andere App, die es gerade nutzt, und tippen Sie dann auf Erneut versuchen.",
  },
  "call.retry": { en: "Retry", de: "Erneut versuchen" },
  "call.chat_instead": { en: "Chat with {name} instead", de: "Stattdessen mit {name} schreiben" },
